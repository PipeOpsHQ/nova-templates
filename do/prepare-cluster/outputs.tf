...
output "grafana_loki_auth_username" {
  sensitive = false
  value     = module.grafana-loki.grafana_loki_auth_username
}

output "grafana_loki_auth_password" {
  sensitive = false
  value     = module.grafana-loki.grafana_loki_auth_password
}
...
output "kube_prom_auth_username" {
  sensitive = false
  value     = module.kube-prometheus-stack.kube_prom_auth_username
}

output "kube_prom_auth_password" {
  sensitive = false
  value     = module.kube-prometheus-stack.kube_prom_auth_password
}
...
output "opencost_auth_password" {
  sensitive = false
  value     = module.opencost.opencost_auth_password
}
...
output "kube_grafana_auth_username" {
  sensitive = false
  value = module.kube-prometheus-stack.kube_grafana_auth_username
}

output "kube_grafana_auth_password" {
  sensitive = false
  value     = module.kube-prometheus-stack.kube_grafana_auth_password
}

output "opencost_api_auth_username" {
  sensitive = false
  value     = module.opencost.opencost_api_auth_username
}

output "opencost_api_auth_password" {
  sensitive = false
  value     = module.opencost.opencost_api_auth_password
}
